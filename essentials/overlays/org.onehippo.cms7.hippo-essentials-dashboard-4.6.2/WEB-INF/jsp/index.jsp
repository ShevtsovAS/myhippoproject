...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/hippo-theme/dist/css/main.css?v=4.6.2"/>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/angular-ui-tree/dist/angular-ui-tree.css?v=4.6.2"/>
  <script type="application/javascript">
    window.SERVER_URL = '<%=request.getScheme()+"://"+request.getServerName()+':'+request.getServerPort()%>';
  </script>

  <%-- HIPPO THEME DEPS --%>
  <script src="${pageContext.request.contextPath}/components/jquery/dist/jquery.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/components/chosen-js/chosen.jquery.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/components/angular/angular.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/components/angular-animate/angular-animate.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/components/angular-aria/angular-aria.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/components/angular-chosen-localytics/dist/angular-chosen.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/components/angular-ui-bootstrap/dist/ui-bootstrap-tpls.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/js/lib/angular-ui-tree.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/components/hippo-theme/dist/js/main.js?v=4.6.2"></script>

  <%-- ESSENTIALS --%>
  <script src="${pageContext.request.contextPath}/components/angular-ui-router/release/angular-ui-router.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/components/angular-sanitize/angular-sanitize.js?v=4.6.2"></script>

  <script src="${pageContext.request.contextPath}/js/app.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/js/routes.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/js/directives.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/js/controllers.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/dashboard/api/services.js?v=4.6.2"></script>
  <script src="${pageContext.request.contextPath}/dashboard/api/directives.js?v=4.6.2"></script>

  <link rel="icon" href="${pageContext.request.contextPath}/images/favicon.ico" type="image/x-icon"/>
  <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/favicon.ico" type="image/x-icon"/>
</head>
<body id="container"  ng-cloak>
<div class="hidden" ng-include="'${pageContext.request.contextPath}/components/hippo-theme/dist/images/hippo-icon-sprite.svg?v=4.6.2'"></div>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${pageContext.request.contextPath}"
         title="version: 4.6.2">Essentials</a>
